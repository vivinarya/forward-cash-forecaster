...
_generated <built-in method isoformat of datetime.date object at 0x7fc67ef75650>; source: template (deterministic numbers, language model used only to phrase them)_
